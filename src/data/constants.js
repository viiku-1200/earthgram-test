...
export const COUNTRIES = [
  // --- South Asia ---
  { id: 'in', name: 'India', flag: '🇮🇳', region: 'south asia', capital: 'New Delhi', gps: [28.6139, 77.2090] },
  { id: 'np', name: 'Nepal', flag: '🇳🇵', region: 'south asia', capital: 'Kathmandu', gps: [27.7172, 85.3240] },
  { id: 'bd', name: 'Bangladesh', flag: '🇧🇩', region: 'south asia', capital: 'Dhaka', gps: [23.8103, 90.4125] },
  { id: 'lk', name: 'Sri Lanka', flag: '🇱🇰', region: 'south asia', capital: 'Colombo', gps: [6.9271, 79.8612] },
  { id: 'pk', name: 'Pakistan', flag: '🇵🇰', region: 'south asia', capital: 'Islamabad', gps: [33.6844, 73.0479] },
  { id: 'bt', name: 'Bhutan', flag: '🇧🇹', region: 'south asia', capital: 'Thimphu', gps: [27.4728, 89.6390] },
  { id: 'mv', name: 'Maldives', flag: '🇲🇻', region: 'south asia', capital: 'Malé', gps: [4.1755, 73.5093] },
  // --- Southeast Asia ---
  { id: 'sg', name: 'Singapore', flag: '🇸🇬', region: 'southeast asia', capital: 'Singapore', gps: [1.3521, 103.8198] },
  { id: 'th', name: 'Thailand', flag: '🇹🇭', region: 'southeast asia', capital: 'Bangkok', gps: [13.7563, 100.5018] },
  { id: 'vn', name: 'Vietnam', flag: '🇻🇳', region: 'southeast asia', capital: 'Hanoi', gps: [21.0278, 105.8342] },
  { id: 'my', name: 'Malaysia', flag: '🇲🇾', region: 'southeast asia', capital: 'Kuala Lumpur', gps: [3.1390, 101.6869] },
  { id: 'id', name: 'Indonesia', flag: '🇮🇩', region: 'southeast asia', capital: 'Jakarta', gps: [-6.2088, 106.8456] },
  { id: 'ph', name: 'Philippines', flag: '🇵🇭', region: 'southeast asia', capital: 'Manila', gps: [14.5995, 120.9842] },
  { id: 'mm', name: 'Myanmar', flag: '🇲🇲', region: 'southeast asia', capital: 'Naypyidaw', gps: [19.7633, 96.0785] },
  { id: 'kh', name: 'Cambodia', flag: '🇰🇭', region: 'southeast asia', capital: 'Phnom Penh', gps: [11.5564, 104.9282] },
  // --- East Asia ---
  { id: 'jp', name: 'Japan', flag: '🇯🇵', region: 'east asia', capital: 'Tokyo', gps: [35.6762, 139.6503] },
  { id: 'kr', name: 'South Korea', flag: '🇰🇷', region: 'east asia', capital: 'Seoul', gps: [37.5665, 126.9780] },
  { id: 'cn', name: 'China', flag: '🇨🇳', region: 'east asia', capital: 'Beijing', gps: [39.9042, 116.4074] },
  { id: 'tw', name: 'Taiwan', flag: '🇹🇼', region: 'east asia', capital: 'Taipei', gps: [25.0330, 121.5654] },
  { id: 'hk', name: 'Hong Kong', flag: '🇭🇰', region: 'east asia', capital: 'Hong Kong', gps: [22.3193, 114.1694] },
  // --- Middle East ---
  { id: 'ae', name: 'UAE', flag: '🇦🇪', region: 'middle east', capital: 'Abu Dhabi', gps: [24.4539, 54.3773] },
  { id: 'sa', name: 'Saudi Arabia', flag: '🇸🇦', region: 'middle east', capital: 'Riyadh', gps: [24.7136, 46.6753] },
  { id: 'qa', name: 'Qatar', flag: '🇶🇦', region: 'middle east', capital: 'Doha', gps: [25.2854, 51.5310] },
  { id: 'kw', name: 'Kuwait', flag: '🇰🇼', region: 'middle east', capital: 'Kuwait City', gps: [29.3759, 47.9774] },
  { id: 'om', name: 'Oman', flag: '🇴🇲', region: 'middle east', capital: 'Muscat', gps: [23.5880, 58.3829] },
  { id: 'bh', name: 'Bahrain', flag: '🇧🇭', region: 'middle east', capital: 'Manama', gps: [26.2285, 50.5860] },
  { id: 'il', name: 'Israel', flag: '🇮🇱', region: 'middle east', capital: 'Jerusalem', gps: [31.7683, 35.2137] },
  { id: 'tr', name: 'Turkey', flag: '🇹🇷', region: 'middle east', capital: 'Ankara', gps: [39.9334, 32.8597] },
  // --- Europe ---
  { id: 'uk', name: 'UK', flag: '🇬🇧', region: 'europe', capital: 'London', gps: [51.5074, -0.1278] },
  { id: 'de', name: 'Germany', flag: '🇩🇪', region: 'europe', capital: 'Berlin', gps: [52.5200, 13.4050] },
  { id: 'fr', name: 'France', flag: '🇫🇷', region: 'europe', capital: 'Paris', gps: [48.8566, 2.3522] },
  { id: 'it', name: 'Italy', flag: '🇮🇹', region: 'europe', capital: 'Rome', gps: [41.9028, 12.4964] },
  { id: 'es', name: 'Spain', flag: '🇪🇸', region: 'europe', capital: 'Madrid', gps: [40.4168, -3.7038] },
  { id: 'nl', name: 'Netherlands', flag: '🇳🇱', region: 'europe', capital: 'Amsterdam', gps: [52.3676, 4.9041] },
  { id: 'ch', name: 'Switzerland', flag: '🇨🇭', region: 'europe', capital: 'Bern', gps: [46.9480, 7.4474] },
  { id: 'se', name: 'Sweden', flag: '🇸🇪', region: 'europe', capital: 'Stockholm', gps: [59.3293, 18.0686] },
  { id: 'pt', name: 'Portugal', flag: '🇵🇹', region: 'europe', capital: 'Lisbon', gps: [38.7223, -9.1393] },
  { id: 'ie', name: 'Ireland', flag: '🇮🇪', region: 'europe', capital: 'Dublin', gps: [53.3498, -6.2603] },
  { id: 'pl', name: 'Poland', flag: '🇵🇱', region: 'europe', capital: 'Warsaw', gps: [52.2297, 21.0122] },
  // --- Americas ---
  { id: 'us', name: 'USA', flag: '🇺🇸', region: 'americas', capital: 'Washington D.C.', gps: [38.9072, -77.0369] },
  { id: 'ca', name: 'Canada', flag: '🇨🇦', region: 'americas', capital: 'Ottawa', gps: [45.4215, -75.6972] },
  { id: 'mx', name: 'Mexico', flag: '🇲🇽', region: 'americas', capital: 'Mexico City', gps: [19.4326, -99.1332] },
  { id: 'br', name: 'Brazil', flag: '🇧🇷', region: 'americas', capital: 'Brasília', gps: [-15.7975, -47.8919] },
  { id: 'ar', name: 'Argentina', flag: '🇦🇷', region: 'americas', capital: 'Buenos Aires', gps: [-34.6037, -58.3816] },
  { id: 'co', name: 'Colombia', flag: '🇨🇴', region: 'americas', capital: 'Bogotá', gps: [4.7110, -74.0721] },
  // --- Africa ---
  { id: 'ng', name: 'Nigeria', flag: '🇳🇬', region: 'africa', capital: 'Abuja', gps: [9.0765, 7.3986] },
  { id: 'za', name: 'South Africa', flag: '🇿🇦', region: 'africa', capital: 'Pretoria', gps: [-25.7479, 28.2293] },
  { id: 'ke', name: 'Kenya', flag: '🇰🇪', region: 'africa', capital: 'Nairobi', gps: [-1.2921, 36.8219] },
  { id: 'eg', name: 'Egypt', flag: '🇪🇬', region: 'africa', capital: 'Cairo', gps: [30.0444, 31.2357] },
  { id: 'gh', name: 'Ghana', flag: '🇬🇭', region: 'africa', capital: 'Accra', gps: [5.6037, -0.1870] },
  { id: 'et', name: 'Ethiopia', flag: '🇪🇹', region: 'africa', capital: 'Addis Ababa', gps: [9.0250, 38.7469] },
  // --- Oceania ---
  { id: 'au', name: 'Australia', flag: '🇦🇺', region: 'oceania', capital: 'Canberra', gps: [-35.2809, 149.1300] },
  { id: 'nz', name: 'New Zealand', flag: '🇳🇿', region: 'oceania', capital: 'Wellington', gps: [-41.2865, 174.7762] },
  { id: 'fj', name: 'Fiji', flag: '🇫🇯', region: 'oceania', capital: 'Suva', gps: [-18.1416, 178.4419] },
];
...
export const REELS_DATA = [
  ...
  { id: '5', creator: '@global_nomad', role: 'Photographer', location: 'Dubai, UAE', desc: 'Shooting the Burj Khalifa at sunset 📸🏙️', likes: '8.2k', comments: '120', videoUrl: 'https://interactive-examples.mdn.mozilla.net/media/cc0-videos/friday.mp4', cta: 'Hire Me', scope: 'global', language: 'English', isHyped: false, views: '50k' },
  ...
  { id: '8', creator: '@ravi_electric', role: 'Electrician', location: 'Ghaziabad, IN', desc: 'Pro tip: Always use ISI marked wires for safety ⚡🔌', likes: '2.1k', comments: '56', videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4', cta: 'Book Now', scope: 'local', language: 'Hindi', isHyped: false, views: '12k' },
  { id: '9', creator: '@fitness_queen', role: 'Fitness Trainer', location: 'Noida, IN', desc: '5-minute morning routine that changed my life 💪🔥', likes: '34k', comments: '890', videoUrl: 'https://interactive-examples.mdn.mozilla.net/media/cc0-videos/friday.mp4', cta: 'Join Now', scope: 'national', language: 'English', isHyped: true, views: '500k' },
  { id: '10', creator: '@green_harvest', role: 'Organic Farmer', location: 'Lucknow, IN', desc: 'Fresh organic veggies straight from our farm 🌿🥦', likes: '3.4k', comments: '67', videoUrl: 'https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4', cta: 'Shop Now', scope: 'local', language: 'Hindi', isHyped: false, views: '18k' },
  { id: '11', creator: '@dj_aryan', role: 'Music Producer', location: 'Mumbai, IN', desc: 'Drop incoming 🎵🎧 New track this Friday! Book me for events', likes: '89k', comments: '2.3k', videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4', cta: 'Book Event', scope: 'national', language: 'English', isHyped: true, views: '1.2M' },
];
