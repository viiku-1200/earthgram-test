...
const ExploreScreen = () => {
  ...
  <div className="h-full flex flex-col bg-gradient-to-b from-white to-gray-50/80 pt-8 pb-20 overflow-y-auto hide-scrollbar">
    ...
    <div className="px-5 pt-2 pb-4">
      <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Explore</h1>
      <p className="text-xs text-gray-400 mt-0.5">Discover your neighborhood</p>
    </div>
    ...
    <div className="px-5 mb-4">
      <div 
        ...
        className="flex items-center bg-gray-100 rounded-2xl px-4 py-3 cursor-pointer active:scale-[0.98] transition-transform">
        <svg className="w-4 h-4 text-gray-400 mr-3" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
        </svg>
        <span className="text-sm text-gray-400 font-medium">Search places, people, interests...</span>
      </div>
    </div>
    ...
    <div className="px-5">
      <div className="flex justify-between items-center mb-3">
        <h2 className="text-sm font-extrabold text-gray-900">Buddies Nearby</h2>
        <span className="text-[9px] font-bold text-indigo-600 bg-indigo-50 px-2.5 py-1 rounded-full flex items-center space-x-1">
    ...
    <div className="mt-6 px-5">
      <h2 className="text-sm font-extrabold text-gray-900 mb-3">Interests & Places</h2>
      <div className="grid grid-cols-3 gap-3">
        {EXPLORE_CATEGORIES.map((cat, i) => (
          <button key={cat.id}
            className="p-4 rounded-2xl flex flex-col items-center justify-center shadow-premium border border-gray-100/50 bg-white card-lift animate-fade-in"
    ...
    <div className="mt-6 px-5 pb-4">
      <h2 className="text-sm font-extrabold text-gray-900 mb-3">Happening Now</h2>
      <div className="space-y-3">
        {LOCAL_SPOTS.map((spot, i) => (
          <div key={spot.id} className="bg-white rounded-2xl shadow-premium border border-gray-100/50 overflow-hidden card-lift animate-fade-in"
